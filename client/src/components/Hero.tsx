...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative h-screen min-h-[700px] flex items-center overflow-hidden bg-slate-900"
    >
      ...
      <div className="container relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl">
          ...
          >
            <h1 className="text-2xl md:text-3xl font-black text-white leading-[1.1] mb-8 tracking-tighter uppercase">
